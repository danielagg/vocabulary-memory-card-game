    ...
    <div class="w-full lg:w-1/2 flex flex-col">
        ...
        <div class="mt-8 lg:mt-12 mx-4 lg:mx-0 bg-gray-50 dark:bg-gray-700 rounded shadow p-12 flex flex-col items-center justify-center">
            ...
            <div class="mt-10 w-full flex flex-col lg:flex-row justify-between items-center space-y-2 lg:space-y-0">
                ...
                <button on:click={onSubmit} class="w-full lg:w-fit bg-gray-700 dark:bg-sky-600 border-2 border-gray-700 dark:border-sky-600 hover:bg-sky-500 hover:border-sky-500  text-gray-100 cursor-pointer py-4 px-16 font-bold rounded-lg lg:rounded-tl-none lg:rounded-bl-none">Submit</button>
            </div>
        </div>
